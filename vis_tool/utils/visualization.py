...
def draw_bbox_8_2D(draw_img, bbox_8_2D, color = (0, 255, 0),front_color = (255, 0, 0), thickness = 2):
    ...
    cv2.line(draw_img, bbox[1], bbox[2], front_color, thickness)
    ...
    cv2.line(draw_img, bbox[5], bbox[6], front_color, thickness)
    ...
    cv2.line(draw_img, bbox[1], bbox[5], front_color, thickness)
    cv2.line(draw_img, bbox[2], bbox[6], front_color, thickness)
...
def draw_detections(image, boxes, scores, labels, rotations, translations, class_to_bbox_3D, camera_matrix, color = None, front_color = None, label_to_name = None, score_threshold = 0.5, draw_bbox_2d = False, draw_name = False):
    ...
    for i in selection:
        ...
        draw_bbox_8_2D(image, points_bbox_2D, color = c, front_color=front_c)
        if draw_name:
